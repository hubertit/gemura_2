...
while IFS=$'\t' read -r legacy_id user_id account_id role permissions status created_at updated_at; do
...
INSERT INTO user_accounts (
    id, legacy_id, user_id, account_id, role, permissions, status, created_at, updated_at
) VALUES (
    '$new_id',
    $legacy_id,
