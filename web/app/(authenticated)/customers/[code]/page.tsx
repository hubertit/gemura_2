...
import Icon, { faStore, faUser, faPhone, faEnvelope, faIdCard, faMapPin, faDollarSign, faEdit, faArrowLeft, faSpinner, faCheckCircle, faCalendar, faBuilding } from '@/app/components/Icon';
      ...
      {searchParams.get('updated') === 'true' && (
        <div className="bg-green-50 border border-green-200 rounded-sm p-4">
          <div className="flex items-center">
            ...
            <p className="text-sm text-green-600">Customer updated successfully!</p>
          </div>
        </div>
      )}
            ...
            <div className="bg-white border border-gray-200 rounded-sm p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between py-2">
                  ...
                  <span className={`px-2 py-1 rounded text-xs font-medium ${
                    customer.relationship.relationship_status === 'active' 
                      ? 'bg-green-100 text-green-700' 
                      : 'bg-gray-100 text-gray-700'
                  }`}>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white border border-gray-200 rounded-sm p-6">
              ...
              <div className="space-y-2">
                <Link href={`/customers/${customerCode}/edit`} className="btn btn-primary w-full justify-center">
                  <Icon icon={faEdit} size="sm" className="mr-2" />
                  Edit Customer
                </Link>
