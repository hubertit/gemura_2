      ...
      <div className="flex flex-wrap items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-1.5">
          <div className="input-group-inline">
            ...
            <DatePicker value={fromDate} onChange={setFromDate} max={new Date().toISOString().slice(0, 10)} placeholder="From" className="w-[130px]" id="payables-from" />
          </div>
          <div className="input-group-inline">
            <span className="input-group-addon text-xs px-2">To</span>
            <DatePicker value={toDate} onChange={setToDate} max={new Date().toISOString().slice(0, 10)} placeholder="To" className="w-[130px]" id="payables-to" />
          </div>
