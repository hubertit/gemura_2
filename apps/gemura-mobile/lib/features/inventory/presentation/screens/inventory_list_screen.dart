...
class _InventoryListScreenState extends ConsumerState<InventoryListScreen> {
  ...
  void _updateShowLowStock(bool value) {
...
// Separate widget class for stock movement dialog
...
// _InventoryListScreenState build method
extension InventoryListScreenBuild on _InventoryListScreenState {
  Widget build(BuildContext context) {
    final filters = InventoryFilters(
      status: _selectedStatus,
      lowStock: _showLowStock ? true : null,
