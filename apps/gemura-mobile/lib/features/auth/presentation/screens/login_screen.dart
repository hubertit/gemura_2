  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      if (e is DioException) {
        ...
        final backendMsg = e.response?.data?['message'] as String?;

        switch (statusCode) {
          case 400:
            errorMessage = backendMsg?.contains('required') == true
                ? 'Please enter both phone/email and password.'
          ...
          case 403:
            ...
            break;
          case 404:
            errorMessage = backendMsg?.isNotEmpty == true
                ? '$backendMsg Sign up below if you don\'t have an account.'
                : 'No account found with this phone number or email. Sign up to create an account.';
            break;
          case 422:
            errorMessage = 'Invalid format. Please check your phone number or email.';
            break;
          case 500:
