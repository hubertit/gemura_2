#!/usr/bin/env python3
"""
Script to post sample agriculture content to Gemura feed
Based on Kigali Today agriculture section
"""
...
# Sample agriculture posts based on Kigali Today content
SAMPLE_POSTS = [
    {
...
def main():
    print("🚀 Starting agriculture content posting...")
    ...
    # Post each sample article
    successful_posts = 0
    
    for i, post in enumerate(SAMPLE_POSTS, 1):
        print(f"\n📝 Processing post {i}/{len(SAMPLE_POSTS)}: {post['title'][:50]}...")
    ...
    print(f"\n🎉 Completed! Successfully posted {successful_posts}/{len(SAMPLE_POSTS)} posts")
