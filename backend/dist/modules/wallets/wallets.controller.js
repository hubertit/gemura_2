...
__decorate([
    (0, common_1.Get)('get'),
    (0, swagger_1.ApiOperation)({ summary: 'Get wallets for default account' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Wallets fetched successfully' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'No wallets found' }),
