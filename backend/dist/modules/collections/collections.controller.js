...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Record milk collection' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Milk collection recorded successfully' }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Supplier account not found' }),
